...
tags: [book]
source: personal reading notes, imported from the author's private notebook
covers: Book 1 ("The Web of Life", "The Pattern That Connects" — the twenty tenets of
...
quotes (blockquotes) and occasional `[Ed: ...]` editorial asides — those asides are the
notebook author's own commentary, not Wilber's text. Kept here as the source used to
curate excerpts for the [concept wiki](../concepts/index.md); see
`docs/concept-wiki-vision.md` for why. Not intended to be read on its own as a
