...
Freud is one of the most heavily cited figures in *Sex, Ecology, Spirituality* (107
mentions), used in two quite different registers. In ch. 6, he's part of the
developmental-structural argument alongside [[piaget|Piaget]]: Freud's account of the
ego (properly "the I," Wilber insists, following the correct translation of Freud's
*das Ich* against Strachey's "ego") and the id (Freud's *Es*, "the it") is read as an
early, still-useful account of how repression works — parts of the self split off and
return as symptoms, "its" that feel alien and beyond conscious control. On the specific
dispute over mythic archetypes staged against [[jung|Jung]], Wilber places Freud (and
Piaget) on the side that archetypal motifs are functionally infantile and regressive
rather than a repository of spiritual wisdom — while noting, against the standard
narrative of Freud and Jung as flatly opposed, that Freud actually agreed with Jung
that such motifs are collectively inherited; the dispute was narrower than usually
remembered, over their *value*, not their *existence*.

The second, larger-scale treatment comes in ch. 9, where Wilber places Freud inside the
book's Ascent/Descent framework (see [[ascent-and-descent]]) and delivers what amounts
to a tragic verdict: Freud saw Eros and Thanatos — the life drive and the death drive —
with unmatched clarity, and saw correctly that human suffering is a permanent battle
between them. But because Freud, unlike [[plotinus|Plotinus]] or Plato, never carried
the path of Ascent through to the unifying One, he had no ground on which Eros and
Thanatos could actually be reconciled. Wilber's verdict is sympathetic rather than
dismissive: Freud is "one of the many, and certainly one of the greatest, of the
fractured footnotes to Plato" — correct as far as he went, but stranded without the
non-dual resolution Wilber thinks the contemplative traditions supply.
...
- [[jung]] — agreed with Freud that archetypes are collectively inherited, disagreed
  sharply on whether they carry genuine spiritual wisdom
- [[piaget]] — sides with Freud functionally on the developmental origin of myth
- [[plotinus]] — the contemplative figure whose completed Ascent gives him the
