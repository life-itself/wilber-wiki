...
Piaget is the structural backbone of *Sex, Ecology, Spirituality* — cited almost
entirely non-polemically, as established developmental fact, and reused more than any
other single framework in the book. His stage sequence (sensorimotor →
preoperational/"magic" → concrete operational/"mythic" → formal operational) is the
mechanism Wilber uses to build his own developmental holarchy of consciousness, and it
does real argumentative work beyond just providing stages: Piaget's account of
**egocentrism** is what lets Wilber overturn the Romantic assumption that "primitive"
or childlike consciousness is somehow *closer* to cosmic unity. Piaget's finding is the
opposite — egocentrism is at its *maximum* in the earliest, least-differentiated
stages, precisely because the self hasn't yet separated out from the world enough to
notice a boundary between them, and it steadily *decreases* as a strong, differentiated
ego (and eventually a properly rational, worldcentric one) emerges. Development is a
progressive *decentering*, not a fall from grace.

Piaget also supplies the shared premise underneath the book's Freud/Jung/Campbell
discussion: he "sides with Freud" on the *function* of mythic archetypes (they're
byproducts of childhood cognitive structure, not directly inherited spiritual content),
while reframing the mechanism as structural rather than phylogenetic — and it's
[[campbell|Campbell]]'s own explicit acceptance of the Piagetian account of myth that
Wilber later turns against Campbell's conclusions.
...
> the self is *not* differentiated from the world... Only with the emergence of a
...
- [[campbell]] — accepts Piaget's developmental account of myth, but (on Wilber's
  reading) misapplies it, committing the pre/trans fallacy
- [[freud]] — Piaget "sides with Freud" on the function of mythic archetypes
- [[jung]] — the dissenting view Piaget and Freud are set against
