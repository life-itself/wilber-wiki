---
title: Lawrence Kohlberg
slug: kohlberg
aliases: [kohlberg, lawrence kohlberg]
relationship: source
status: draft
...
Kohlberg's stages of moral development are one of the empirical anchors Wilber leans on
for the preconventional-conventional-postconventional sequence that runs through *SES*
as a general template for growth, not just morality specifically. Wilber is candid that
"not everybody agrees with the details" of Kohlberg's original scheme — he flags Carol
Gilligan's revision up front — but treats the disagreement as internal to the
Kohlberg/Gilligan research program rather than a challenge to the underlying three-tier
hierarchy itself: Gilligan, Wilber stresses, accepts Kohlberg's general hierarchical
structure and only supplements the logic of justice with a logic of care, so that men
and women progress through "the *same* hierarchy" by somewhat different routes. Kohlberg
and Gilligan together, alongside [[habermas|Habermas]], [[loevinger|Loevinger]], Piaget,
and others, supply Wilber's evidence that moral maturation runs from egocentric to
sociocentric to worldcentric — the same broad arc Wilber generalizes across cognition,
self-identity, and needs, and treats as one more line of evidence for a single underlying
developmental logic playing out across many domains of the person.
...
*Integral Psychology* gives Kohlberg a fuller defense against the two standard
objections (gender bias, Eurocentrism) than *SES* does, and adds his own highest,
explicitly transpersonal stage — absent from the *SES* treatment.

> The pivotal figure here is Lawrence Kohlberg...whose work, building on that of
...
- [[loevinger]] — parallel ego-development stages Wilber treats as tracking the same
  underlying sequence
